"""
V5 프롬프트 테스트 (V3 업그레이드 + V5 하드 룰 + 구조화 입력)
ESConv 100개 샘플
"""
import json
import random
...
from src.llm.prompts_v5 import JUDGE_SYSTEM, build_judge_prompt
...
def main():
    print("=" * 60)
    print("V5 프롬프트 테스트 (V3 + V5 하드 룰 + SUMMARY)")
    print("=" * 60)
    ...
    # Save results
    output_path = "test_judge_v5_100.json"
